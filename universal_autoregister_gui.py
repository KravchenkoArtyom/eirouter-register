"""Lightweight Tkinter front end for universal_autoregister.py."""
...
from universal_autoregister import ROOT, SCENARIOS, load_scenarios
...
class App(tk.Tk):
    ...
    def _run(self) -> None:
        ...
        try:
            ...
            return
        command = [sys.executable, str(ROOT / "universal_autoregister.py"),
